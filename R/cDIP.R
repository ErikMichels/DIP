cDIP <- function(new_data) {
  ...
  message("This function uses Python. If not installed please install Python. Make sure to click ADD PYTHON TO PATH. The first time use might take a few minutes. You might need to restart R afterwards.")
